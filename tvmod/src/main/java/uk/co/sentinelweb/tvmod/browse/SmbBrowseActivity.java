...
public class SmbBrowseActivity extends Activity {
    ...
    SmbBrowseMvpContract.View fragment;
    /**
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        fragment = (SmbBrowseFragment) getFragmentManager().findFragmentById(R.id.main_browse_fragment);
        final SmbBrowseMvpContract.Presenter presenter = new SmbBrowsePresenter(fragment);
